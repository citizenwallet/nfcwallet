...
const communitySlug = "wallet.commonshub.brussels";
...
const formData = {
  ...
  communitySlug,
  name: "TEST-Xavier",
  username: "TEST-xdamman",
  description: "TEST Short bio",
  twitter: "TEST-xdamman",
  telegram: "TEST-xdamman",
  linkedin: "TEST-xavierdamman",
...
describe("api.setProfile", () => {
  ...
  it.skip("should return an error if username is taken", async () => {
