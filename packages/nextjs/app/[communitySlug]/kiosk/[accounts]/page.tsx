...
import KioskProfile from "~~/components/KioskProfile";
...
export default async function KioskPage({ params }: { params: { communitySlug: string; accounts: string } }) {
  ...
  return (
    ...
    >
      <KioskProfile
        ...
        accounts={decodeURIComponent(params.accounts).split(",")}
        theme={theme(config)}
        poap={poapOfTheDay}
        redirectUrl={`/${params.communitySlug}/kiosk`}
      />
